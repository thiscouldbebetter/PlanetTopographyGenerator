...
(function (ThisCouldBeBetter) {
    ...
    (function (PlanetTopographyGenerator) {
        class Coords {
            ...
            crossProduct(other) {
                return this.overwriteWithXYZ(this.y * other.z - this.z * other.y, this.z * other.x - this.x * other.z, this.x * other.y - this.y * other.x);
            }
            divideScalar(scalar) {
                this.x /= scalar;
                this.y /= scalar;
        ...
        PlanetTopographyGenerator.Coords = Coords;
